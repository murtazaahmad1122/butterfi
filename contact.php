...
<!-- Mirrored from expert-themes.com/html/globex/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 29 Mar 2022 08:11:15 GMT -->
<head>
<meta charset="utf-8">
<title>Butterfi</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <header class="main-header header-style-two ">
					...
					<nav class="main-menu navbar-expand-md">
						...
						<div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
							<ul class="navigation clearfix">
								...
								<li class=""><a href="services.html">Our Services</a>
		...
		<!-- Sticky Header  -->
        <div class="sticky-header .d-sm-none">
	...
	<!--Page Title-->
	<section class="banner-section-two" style="background: rgba(255, 255, 255, 0) url(images/main-slider/bg-image.jpg) no-repeat scroll center center / cover;">
					...
					<div class="row clearfix">
						...
						<div class="content-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column">
								...
								<h1>Contact Us <br></h1>
								<h4 style="color: white;">Get more funding offers<br> with better deal terms</h4>
							...
							<div class="image-column col-lg-6 col-md-12 col-sm-12">
								<div class="inner-column">
									<div class="image">
										<img src="images/main-slider/contact.png" alt="" />
									</div>
								</div>
							</div>
						</div>
				...
				<form method="post" action="">
					<div class="row clearfix">
						...
						<div class="col-lg-8 col-md-6 col-sm-12 form-group">
							<input type="text" name="department" placeholder="Company" required="">
						...
						<div class="row clearfix">
                            ...
                            <div class="footer-column col-lg-7 col-md-6 col-sm-12">
                                <div class="footer-widget logo-widget">
									...
									<div class="text">he Butterfi process protects your private information at the highest level. Butterfi’s onboarding process does not require connecting your databases, nor does it call you to export your data to us</div>
									<!-- Social Box -->
									<ul class="social-box">		
...
<!-- Mirrored from expert-themes.com/html/globex/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 29 Mar 2022 08:12:03 GMT -->
</html>